import { 
  User, Swords, Layout, Library, Target, Clock, Zap, Package, Trophy, ShoppingBag, Settings, FolderOpen, Mic
} from 'lucide-react';
...
export const navItems = [
  ...
  { id: 'quests', label: 'Mission Board', icon: Swords, desc: 'Daily Study Tasks' },
  ...
  { id: 'settings', label: 'System Options', icon: Settings, desc: 'Configuration' },
];
